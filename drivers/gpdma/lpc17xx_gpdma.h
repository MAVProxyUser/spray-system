...
#ifndef __LPC17XX_GPDMA_H__
#define __LPC17XX_GPDMA_H__

/* Exported define -----------------------------------------------------------*/
/* GPDMA register map */
#define REG_DMACIntStat           	(*(__IO CPU_INT32U *)  (0x50004000))
#define REG_DMACIntTCStat         	(*(__IO CPU_INT32U *)  (0x50004004))
#define REG_DMACIntTCClear 			(*(__IO CPU_INT32U *)  (0x50004008))
#define REG_DMACIntErrStat 			(*(__IO CPU_INT32U *)  (0x5000400C))
#define REG_DMACIntErrClr			(*(__IO CPU_INT32U *)  (0x50004010))
#define REG_DMACRawIntTCStat 		(*(__IO CPU_INT32U *)  (0x50004014))
#define REG_DMACRawIntErrStat 		(*(__IO CPU_INT32U *)  (0x50004018))
#define REG_DMACEnbldChns	        (*(__IO CPU_INT32U *)  (0x5000401C))
#define REG_DMACSoftBReq			(*(__IO CPU_INT32U *)  (0x50004020))
#define REG_DMACSoftSReq			(*(__IO CPU_INT32U *)  (0x50004024))
#define REG_DMACSoftLBReq			(*(__IO CPU_INT32U *)  (0x50004028))
#define REG_DMACSoftLSReq			(*(__IO CPU_INT32U *)  (0x5000402C))
#define REG_DMACConfig				(*(__IO CPU_INT32U *)  (0x50004030))
#define REG_DMACSync				(*(__IO CPU_INT32U *)  (0x50004034))

#define DMAREQSEL             	(*(__IO CPU_INT32U *)  ( 0x400FC1C4))

/* channel 0 register map */
#define REG_DMACC0SrcAddr           (*(__IO CPU_INT32U *)  (0x50004100))
#define REG_DMACC0DestAddr 			(*(__IO CPU_INT32U *)  (0x50004104))
#define REG_DMACC0LLI    			(*(__IO CPU_INT32U *)  (0x50004108))
#define REG_DMACC0Control 			(*(__IO CPU_INT32U *)  (0x5000410C))
#define REG_DMACC0Config  			(*(__IO CPU_INT32U *)  (0x50004110))
/* channel 1 register map */
#define REG_DMACC1SrcAddr           (*(__IO CPU_INT32U *)  (0x50004120))
#define REG_DMACC1DestAddr 			(*(__IO CPU_INT32U *)  (0x50004124))
#define REG_DMACC1LLI    			(*(__IO CPU_INT32U *)  (0x50004128))
#define REG_DMACC1Control 			(*(__IO CPU_INT32U *)  (0x5000412C))
#define REG_DMACC1Config  			(*(__IO CPU_INT32U *)  (0x50004130))
...
#define GPDMA_DMACCxControl_SI				DEF_BIT_26          //((1UL<<26)) 		/**< Source increment*/
#define GPDMA_DMACCxControl_DI				DEF_BIT_27          //((1UL<<27)) 		/**< Destination increment*/
#define GPDMA_DMACCxControl_Prot1			DEF_BIT_28          //((1UL<<28)) 		/**< Indicates that the access is in user mode or privileged mode*/
#define GPDMA_DMACCxControl_Prot2			DEF_BIT_29          //((1UL<<29)) 		/**< Indicates that the access is bufferable or not bufferable*/
#define GPDMA_DMACCxControl_Prot3			DEF_BIT_30          //((1UL<<30)) 		/**< Indicates that the access is cacheable or not cacheable*/
#define GPDMA_DMACCxControl_I				DEF_BIT_31          //((1UL<<31)) 		/**< Terminal count interrupt enable bit */

#define DMACCxControl_SBS_BIT_SHIFT		    DEF_BIT_12
#define DMACCxControl_SBS_BIT_NUMBERS	    1u

#define DMACCxControl_DBS_BIT_SHIFT		    DEF_BIT_15
#define DMACCxControl_DBS_BIT_NUMBERS	    1u

#define DMACCxControl_SW_BIT_SHIFT		    DEF_BIT_18
#define DMACCxControl_SW_BIT_NUMBERS	    1u

#define DMACCxControl_DW_BIT_SHIFT		    DEF_BIT_21
#define DMACCxControl_DW_BIT_NUMBERS	    1u
